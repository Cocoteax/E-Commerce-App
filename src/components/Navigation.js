    ...
    <Navbar expand="lg" className="mt-2">
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto text-center" variant="underline" defaultActiveKey="#home">
          ...
          <Nav className="ms-auto me-4">
            <div className={`d-flex justify-content-around align-items-center ${styles.iconDiv}`}>
              <Nav.Link
                href="#search"
